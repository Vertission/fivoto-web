  ...
  return (
    <>
      {loading ? (
        ...
        <LinearProgress variant="determinate" value={activeStep * 33.33} />
      )}
      <div className={classes.root}>
        ...
        <Container className={classes.btnGrp}>
          ...
          {activeStep === 0 || activeStep === 1 || activeStep === 3 ? null : (
            <Button
              onClick={handleNext}
...
const ColorlibConnector = withStyles({
  ...
  active: {
    "& $line": {
      backgroundImage:
        "linear-gradient(90deg, #5bd592 0%, #5bd592 35%, #5bd592 100%)",
    },
  },
  completed: {
    "& $line": {
...
const useColorlibStepIconStyles = makeStyles((theme) => ({
  ...
  active: {
    backgroundImage:
      "linear-gradient(301deg, #5bd592 0%, #5bd592 35%, #5bd592 100%)",
